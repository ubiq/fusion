...
let menuTempl = function(webviews) {
        ...
        submenu: [
          {
            ...
            click() {
              ...
              if (ethereumNode.isEth) {
                ...
                if (process.platform === 'darwin') {
                  userPath += '/Library/Ubiq/keystore';
                }
                ...
                if (
                  ...
                  userPath += '/.ubiq/keystore';
                }

                if (process.platform === 'win32') {
                  userPath = `${Settings.appDataPath}\\Ubiq\\keystore`;
                }
              }
  ...
  if (process.platform === 'darwin' || process.platform === 'win32') {
    ...
    if (gethClient) {
      nodeSubmenu.push({
        label: `Gubiq ${gethClient.version}`,
  ...
  helpMenu.push(
    {
      ...
      click() {
        shell.openExternal('https://github.com/ubiq/ethereum/wiki');
      }
    },
    /*{
      label: i18n.t('mist.applicationMenu.help.gitter'),
      click() {
        shell.openExternal('https://gitter.im/ubiq/fusion');
      }
    },*/
    {
      label: i18n.t('mist.applicationMenu.help.reportBug'),
      click() {
        shell.openExternal('https://github.com/ubiq/fusion/issues');
      }
    }
  );
