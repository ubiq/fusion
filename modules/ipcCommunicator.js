      ...
      if (type === 'ethersale') {
        ...
        if (ethereumNode.isEth) {
          ...
          if (process.platform === 'darwin')
            keystorePath += '/Library/Ubiq/keystore';
          ...
          if (
            ...
            keystorePath += '/.ubiq/keystore';

          if (process.platform === 'win32')
            keystorePath = `${Settings.appDataPath}\\Ubiq\\keystore`;
        }
...
ipc.on('mistAPI_requestAccount', e => {
  if (global.mode === 'wallet') {
    ...
    if (e.sender.history[0] === 'https://wallet.ubiqscan.io/') {
      createAccountPopup(e);
    } else {
